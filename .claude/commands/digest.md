...
When auto-running: Generate and save to `.autopilot/docs/decisions/digests/YYYY-MM-DD.md`
...
>> Review: .autopilot/docs/decisions/pending.md
...
Full decision queue: .autopilot/docs/decisions/pending.md
Historical digests: .autopilot/docs/decisions/digests/
...
DIGEST_FILE=".autopilot/docs/decisions/digests/$(date +%Y-%m-%d).md"
